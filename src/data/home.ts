export const homeHeroBullets = [
  'Diagnóstico operativo antes de proponer tecnología',
  'Definición conjunta del flujo, alcance y prioridad real',
  'Implementación con acompañamiento para que el cambio se use'
];
